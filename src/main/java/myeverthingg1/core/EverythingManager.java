...
public class EverythingManager {
    ...
    public void buildIndex() {
        //建立索引
        DataSourceFactory.databaseInit(true); //删除旧表，创建新表
        HandlerPath handlerPath = config.getHandlerPath(); // 得到管理路径的类
        Set<String> includePaths = handlerPath.getIncludePath(); //得到要存储的路径
        new Thread(()-> {
